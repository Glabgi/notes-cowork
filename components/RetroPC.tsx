...
const SETS: string[][] = [
  ['C:\\> STUDY.EXE', 'Loading...', 'ТИХИЙ ЗАЛ', 'ver 1.0  (c)1984', 'session start...', 'lo-fi mode ON', 'focus: ACTIVE'],
  ['ТИХИЙ ЗАЛ', '───────────────', 'Садись и учись.', 'Lo-fi играет.', 'Рядом — тишина.', 'Все в фокусе.', 'together'],
