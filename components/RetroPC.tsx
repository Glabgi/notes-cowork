...
const SETS: string[][] = [
  ['C:\\> STUDY.EXE', 'Loading...', 'NOTES COWORK', 'ver 1.0  (c)1984', 'session start...', 'lo-fi mode ON', 'focus: ACTIVE'],
  ['NOTES COWORK', '───────────────', 'Садись и учись.', 'Lo-fi играет.', 'Рядом — тишина.', 'Все в фокусе.', 'together'],
